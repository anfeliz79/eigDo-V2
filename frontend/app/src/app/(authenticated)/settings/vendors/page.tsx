            ...
            {TARGET_FIELDS.map(({ key, label, description, type: fieldType }) => {
              ...
              return (
                <div key={key} className="bg-white rounded-2xl border border-gray-200 shadow-sm p-5">
                  ...
                  {key === 'Rnc' && mapping?.qboFieldPath === 'TaxIdentifier' && (
                    <div className="flex items-start gap-2 mt-2 px-3 py-2 bg-amber-50 border border-amber-200 rounded-lg">
                      ...
                      <p className="text-xs text-amber-700">
                        Intuit enmascara este campo en su API — solo muestra los ultimos digitos (ej. <span className="font-mono">XXXX-1234</span>). El RNC completo no se puede leer desde QuickBooks. Ingresalo manualmente en cada proveedor.
                      </p>
                    </div>
                  )}
